...
namespace RateChanger
{
    ...
    #error "Sampletype not defined"
        ...
        public static int Start(string[] args, float tempoChange, bool keepPitch)
        {
            WavInFile inFile;
            WavOutFile outFile;
            ...
            try
            {
                ...
                var parameters = new RunParameters(args, tempoChange, keepPitch);
